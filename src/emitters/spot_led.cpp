...
class SpotLightLED final : public Emitter<Float, Spectrum> {
public:
    MTS_IMPORT_BASE(Emitter, m_flags, m_medium, m_world_transform)
    MTS_IMPORT_TYPES(Scene, Texture)

    SpotLightLED(const Properties &props) : Base(props) {
...
MTS_IMPLEMENT_CLASS_VARIANT(SpotLightLED, Emitter)
MTS_EXPORT_PLUGIN(SpotLightLED, "SpotLED emitter")
